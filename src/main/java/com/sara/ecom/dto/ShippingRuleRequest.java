...
public class ShippingRuleRequest {
    ...
    private List<ShippingRangeRequest> ranges;
    
    public static class ShippingRangeRequest {
        private Long id;
    ...
    public List<ShippingRangeRequest> getRanges() { return ranges; }
    public void setRanges(List<ShippingRangeRequest> ranges) { this.ranges = ranges; }
}
